...
function TPessoaController.Contar: Integer;
begin
  Result := FPessoaApi.Contar;
end;
...
function TPessoaController.ImportarCSV_Stream(const AFileName: string;
  const ATamanhoLote: Integer): Integer;
begin
