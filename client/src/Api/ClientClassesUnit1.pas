...
type
  ...
  private
    ...
    FViaCEP_ProcessadosCommand: TDSRestCommand;
    FViaCEP_TotalCommand: TDSRestCommand;
    ...
    FViaCEP_ProcessadosIgualTotalCommand: TDSRestCommand;
  ...
  public
    ...
    function ViaCEP_Processados(const ARequestFilter: string = ''): Integer;
    function ViaCEP_Total(const ARequestFilter: string = ''): Integer;
    procedure ViaCEP_Disparar;
    function ViaCEP_Status(const ARequestFilter: string = ''): string;
    function DispararCepEstaEmExecucao(const ARequestFilter: string = ''): Boolean;
    function ViaCEP_ProcessadosIgualTotal(const ARequestFilter: string = ''): Boolean;
...
const
  ...
  TServerMethods1_ViaCEP_Processados: array [0..0] of TDSRestParameterMetaData =
  (
    (Name: ''; Direction: 4; DBXType: 6; TypeName: 'Integer')
  );

  TServerMethods1_ViaCEP_Total: array [0..0] of TDSRestParameterMetaData =
  (
    (Name: ''; Direction: 4; DBXType: 6; TypeName: 'Integer')
  );
  ...
  TServerMethods1_ViaCEP_ProcessadosIgualTotal: array [0..0] of TDSRestParameterMetaData =
  (
    (Name: ''; Direction: 4; DBXType: 4; TypeName: 'Boolean')
  );
...
function TServerMethods1Client.ViaCEP_Processados(const ARequestFilter: string): Integer;
begin
  if FViaCEP_ProcessadosCommand = nil then
  begin
    FViaCEP_ProcessadosCommand := FConnection.CreateCommand;
    FViaCEP_ProcessadosCommand.RequestType := 'GET';
    FViaCEP_ProcessadosCommand.Text := 'TServerMethods1.ViaCEP_Processados';
    FViaCEP_ProcessadosCommand.Prepare(TServerMethods1_ViaCEP_Processados);
  end;
  FViaCEP_ProcessadosCommand.Execute(ARequestFilter);
  Result := FViaCEP_ProcessadosCommand.Parameters[0].Value.GetInt32;
end;

function TServerMethods1Client.ViaCEP_Total(const ARequestFilter: string): Integer;
begin
  if FViaCEP_TotalCommand = nil then
  begin
    FViaCEP_TotalCommand := FConnection.CreateCommand;
    FViaCEP_TotalCommand.RequestType := 'GET';
    FViaCEP_TotalCommand.Text := 'TServerMethods1.ViaCEP_Total';
    FViaCEP_TotalCommand.Prepare(TServerMethods1_ViaCEP_Total);
  end;
  FViaCEP_TotalCommand.Execute(ARequestFilter);
  Result := FViaCEP_TotalCommand.Parameters[0].Value.GetInt32;
end;
...
function TServerMethods1Client.DispararCepEstaEmExecucao(const ARequestFilter: string): Boolean;
begin
  ...
  FDispararCepEstaEmExecucaoCommand.Execute(ARequestFilter);
  Result := FDispararCepEstaEmExecucaoCommand.Parameters[0].Value.GetBoolean;
end;

function TServerMethods1Client.ViaCEP_ProcessadosIgualTotal(const ARequestFilter: string): Boolean;
begin
  if FViaCEP_ProcessadosIgualTotalCommand = nil then
  begin
    FViaCEP_ProcessadosIgualTotalCommand := FConnection.CreateCommand;
    FViaCEP_ProcessadosIgualTotalCommand.RequestType := 'GET';
    FViaCEP_ProcessadosIgualTotalCommand.Text := 'TServerMethods1.ViaCEP_ProcessadosIgualTotal';
    FViaCEP_ProcessadosIgualTotalCommand.Prepare(TServerMethods1_ViaCEP_ProcessadosIgualTotal);
  end;
  FViaCEP_ProcessadosIgualTotalCommand.Execute(ARequestFilter);
  Result := FViaCEP_ProcessadosIgualTotalCommand.Parameters[0].Value.GetBoolean;
end;
...
begin
  ...
  FViaCEP_ProcessadosCommand.Free;
  FViaCEP_TotalCommand.Free;
  FViaCEP_DispararCommand.Free;
  FViaCEP_StatusCommand.Free;
  FDispararCepEstaEmExecucaoCommand.Free;
  FViaCEP_ProcessadosIgualTotalCommand.Free;
