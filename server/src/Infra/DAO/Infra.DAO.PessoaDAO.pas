...
class function TPessoaDAO.ContarPessoas(const AConexao: TFDConnection): Integer;
var
  LQuery: TFDQuery;
begin
  LQuery := TFDQuery.Create(nil);
  try
    LQuery.Connection := AConexao;
    LQuery.SQL.Text := 'select count(*) as total from pessoa';
    LQuery.Open;
